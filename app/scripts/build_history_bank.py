...
"""
    with open('app/src/main/java/com/example/data/repository/JambHistory2012ExamBank.kt', 'w') as f:
        f.write(content)
    print("Created JambHistory2012ExamBank.kt")
