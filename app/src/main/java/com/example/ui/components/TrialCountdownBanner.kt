...
fun TrialMilestoneReminderDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = "Prepza Trial: $milestoneDaysLeft Days Left",
        ...
        text = {
            Text(
                text = "You have $milestoneDaysLeft days remaining in your free Prepza trial. Upgrade now for just ₦500 via Paystack to keep unlimited access to 20,000+ JAMB questions, the complete Literature library, and offline practice forever!",
        ...
        confirmButton = {
            Button(
                ...
                Text("Upgrade with Paystack (₦500)")
            }
        },
        dismissButton = {
