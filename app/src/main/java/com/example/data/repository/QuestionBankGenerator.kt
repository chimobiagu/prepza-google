...
object QuestionBankGenerator {
    ...
    fun getAllSeedQuestions(): List<QuestionEntity> {
        ...
        questions.addAll(JambMathematics1983to2004Bank.getQuestions())
        questions.addAll(JambChemistry1983to2004Bank.getQuestions())
        questions.addAll(JambGovernment1983to2004Bank.getQuestions())
        questions.addAll(JambMathematics2010to2018CompleteExamBank.getQuestions())
        questions.addAll(JambPhysics2010to2018CompleteExamBank.getQuestions())
        questions.addAll(JambEnglish2010to2018ExamCompleteBank.getQuestions())
        ...
        questions.addAll(JambEnglishGrammarLexisMegaBank.getQuestions())
        questions.addAll(JambFurtherMathematicsMasterBank.getQuestions())
        questions.addAll(JambGeographyComprehensiveMasterBank.getQuestions())
        questions.addAll(JambHistoryComprehensiveMasterBank.getQuestions())
        questions.addAll(JambIrsComprehensiveMasterBank.getQuestions())
        questions.addAll(JambMathematicsMegaMasteryBank.getQuestions())
        questions.addAll(JambPhysicsMegaMasteryBank.getQuestions())
        questions.addAll(JambChemistryMegaMasteryBank.getQuestions())
        questions.addAll(JambBiologyMegaMasteryBank.getQuestions())
        questions.addAll(JambEconomicsMegaMasteryBank.getQuestions())
        questions.addAll(JambGovernmentMegaMasteryBank.getQuestions())
        questions.addAll(JambCommerceMegaMasteryBank.getQuestions())
        questions.addAll(JambLiteratureInEnglishMegaMasteryBank.getQuestions())
        questions.addAll(JambPrinciplesOfAccountsMegaMasteryBank.getQuestions())
        questions.addAll(JambCrsMegaMasteryBank.getQuestions())
        questions.addAll(JambEnglishPassageMegaExtensionBank.getQuestions())
        questions.addAll(JambMathsPhysicsExtensionBank.getQuestions())
        questions.addAll(JambChemBioExtensionBank.getQuestions())
        questions.addAll(JambCommercialMegaExtensionBank.getQuestions())
        questions.addAll(JambArtsMasteryExtensionBank.getQuestions())
        questions.addAll(JambGeoFurtherMathExtensionBank.getQuestions())
        questions.addAll(JambApexFinalExpansionBank.getQuestions())
