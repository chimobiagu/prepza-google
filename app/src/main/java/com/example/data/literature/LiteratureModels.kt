...
data class LiteratureCharacter(
    ...
    val description: String = "",
    val keyActionsAndQuotes: List<String> = emptyList(),
...
data class LiteratureBookStudyData(
    ...
    val isPoetry: Boolean get() = category.contains("Poem", ignoreCase = true) || 
            category.contains("Poetry", ignoreCase = true) || 
            title.contains("Poem", ignoreCase = true) || 
            title.contains("Haiku", ignoreCase = true) ||
            id.contains("haiku", ignoreCase = true) ||
            id.contains("beauty", ignoreCase = true)

    val isDrama: Boolean get() = category.contains("Drama", ignoreCase = true) || 
            category.contains("Play", ignoreCase = true) ||
            id.contains("lion", ignoreCase = true) ||
            id.contains("anger", ignoreCase = true)

    val isProse: Boolean get() = !isPoetry && !isDrama
}
