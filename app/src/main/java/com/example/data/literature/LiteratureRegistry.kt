...
object LiteratureRegistry {
    ...
    init {
        ...
        registerBook(buildModernHaikuData())
    }
    ...
    /**
     * Highly scalable resolver (PART 1 & 17):
     * If an entity exists in Room database that is not yet registered in memory,
     * dynamically synthesizes and registers full study modules from its metadata & chaptersJson.
     */
    fun getOrCreateStudyData(entity: LiteratureBookEntity): LiteratureBookStudyData {
        val existing = getBookById(entity.id) ?: booksMap.values.find {
            it.title.equals(entity.title, ignoreCase = true) || entity.title.contains(it.title, ignoreCase = true)
        }
        if (existing != null) return existing

        val generated = generateStudyDataFromEntity(entity)
        registerBook(generated)
        return generated
    }
    ...
    // -------------------------------------------------------------
    // 8. MODERN HAIKU (Selected Poets & UTME Poetic Anthology)
    // -------------------------------------------------------------
    private fun buildModernHaikuData(): LiteratureBookStudyData {
        val haikuChapters = listOf(
            LiteratureChapter(
                chapterNumber = 1,
                title = "Poem 1: Spring Awakening & Water Cycle",
                summary = "A sudden raindrop ripples across a still pond, breaking the silence and awakening life.",
                keyQuotes = listOf("A sudden raindrop", "Silence finds its voice"),
                fullText = """
                    A sudden raindrop
                    ...
                    --- STANZA ANALYSIS ---
                    • Syllabic Structure: 5-7-5 syllables (classical unrhymed tercet).
                    • Kigo (Season Word): 'Raindrop' signaling the onset of the early rainy season.
                    • Kireji (Cutting Break): The dash after 'pond—' creates a pregnant pause separating visual cause from auditory effect.
                    • Imagery: Visual ripple on green water leading to auditory awakening.
                    • Philosophical Meaning: Nature speaks through subtle disturbances; small actions cause wide echoes.
                """.trimIndent()
            ),
            LiteratureChapter(
                chapterNumber = 2,
                title = "Poem 2: Savanna Sun & Peasant Labor",
                summary = "The rural farmer strikes the parched soil with a hoe, enduring dry heat while anticipating rain.",
                keyQuotes = listOf("Dry savanna dust", "The hoe strikes the iron earth"),
                fullText = """
                    Dry savanna dust,
                    ...
                    --- STANZA ANALYSIS ---
                    • Syllabic Structure: 5-7-5 syllables.
                    • Setting & Context: African tropical savanna facing drought before the rainy season.
                    • Tactile & Visual Imagery: 'Dry savanna dust' (tactile/visual), 'iron earth' (metaphor for hardened soil).
                    • Auditory Imagery: The rhythmic clang of the metal hoe striking dry clay.
                    • Exam Focus: Juxtaposition of human endurance and the stoic hope for renewal.
                """.trimIndent()
            ),
            LiteratureChapter(
                chapterNumber = 3,
                title = "Poem 3: Harmattan Wind & Cold Dawn",
                summary = "The dry northeast trade wind blows haze over rooftops in early morning silence.",
                keyQuotes = listOf("Dry grass in the wind", "The cold dawn whispers"),
                fullText = """
                    ...
                    --- STANZA ANALYSIS ---
                    • Kigo (Seasonal Marker): Harmattan breeze and settling dust.
                    • Personification: 'The cold dawn whispers' assigns human communicative tenderness to an otherwise harsh climate.
                    • Tone & Mood: Quiet, introspective, melancholic, yet peaceful.
                    • Symbolism: The dust over roofs represents nature gently covering human habitations.
                """.trimIndent()
            ),
            LiteratureChapter(
                chapterNumber = 4,
                title = "Poem 4: Twilight Flight of the Egret",
                summary = "A solitary white bird glides across a flaming sunset as dusk descends.",
                keyQuotes = listOf("White egret takes flight", "Night gathers the sky"),
                fullText = """
                    ...
                    --- STANZA ANALYSIS ---
                    • Color Contrast: Pristine white plumage set against blazing crimson dusk.
                    • Personification: 'Night gathers the sky' depicts night as a watchful weaver or shepherd collecting the day.
                    • Theme: The transition from light to dark, mortality, and transcendent grace.
                """.trimIndent()
            ),
            LiteratureChapter(
                chapterNumber = 5,
                title = "Poem 5: City Metro & Fleeting Humanity",
                summary = "Modern urban isolation dissolved by an instantaneous shared smile.",
                keyQuotes = listOf("Reflections in glass dissolve", "A stranger's warm smile"),
                fullText = """
                    ...
                    --- STANZA ANALYSIS ---
                    • Modern Context: The mechanical rush of rapid urban transit.
                    • Epiphany (Satori): In a crowded, alienated city, a simple human gesture pierces cold technological glass.
                    • Device: Metaphor of dissolved reflections versus lasting human connection.
                """.trimIndent()
            )
        )
        ...
        return LiteratureBookStudyData(
            ...
            authorInfo = AuthorInfo(
                name = "World & African Haiku Anthology",
                lifespan = "20th & 21st Century Poetic Form",
                nationality = "Global / African Anthology",
                biography = "Haiku originated in 17th-century Japan under masters such as Matsuo Bashō, Yosa Buson, and Kobayashi Issa. In the 20th and 21st centuries, modern poets worldwide (including Richard Wright's pioneering African-American haiku and contemporary West African poets) adapted the form to capture African landscapes, sociopolitical realities, and modern urban transitions with radical economy and heightened mindfulness.",
                notableWorks = listOf("Haiku: This Other World", "The Narrow Road to the Deep North", "Savanna Haiku Anthology"),
                literaryMovementOrPeriod = "Imagism / Modernist Lyric Poetry / Zen Aesthetic Realism",
                examSignificance = "Prescribed poetry form testing candidates on brevity, syllabic structure (5-7-5), kigo (seasonal markers), kireji (cutting words), objective correlative, and sensory imagery."
            ),
            category = "Selected UTME Poems",
            publicationYear = "Contemporary UTME Poetic Anthology",
            tagline = "Radical brevity, sensory imagery, season markers, and flashes of philosophical awareness.",
            coverAccentColor = Color(0xFF00695C),
            totalChaptersCount = haikuChapters.size,
            chapters = haikuChapters,
            background = LiteratureBackground(
                historicalContext = "Originating in Japanese renga tradition, modernized in the 20th century into standalone tercets capturing instantaneous perceptions of reality without excessive ornament.",
                socialContext = "Contrasts the rapid pace of industrialized society with contemplative attentiveness to nature, agricultural labor, and seasonal transitions.",
                circumstancesSurroundingWork = "Included in UTME literature syllabus to teach students precision of language, economy of expression, and keen sensory observation.",
                targetExamRelevance = "Regularly tested on stanza structure, identification of sensory imagery (visual, auditory, tactile), personification, and kigo."
            ),
            plot = LiteraturePlot(
                overview = "A thematic poetic cycle progressing through seasonal changes (Spring rain, Summer dust, Harmattan haze, Twilight) into urban consciousness, portraying nature and humanity in reciprocal harmony.",
                beginning = PlotStage("1. Spring Awakening", "The First Rain", "The sudden disturbance of still water initiating life and breaking winter's silence.", listOf("Raindrop strikes pond", "Silence awakens")),
                majorEvents = PlotStage("2. Heat and Labor", "Savanna Dust", "Peasant persistence against the hardened soil under intense heat.", listOf("Hoe strikes iron earth", "Awaiting storm clouds")),
                turningPoints = PlotStage("3. The Harmattan Chill", "Cold Dust", "The seasonal wind settling fine sand over sleeping homes.", listOf("Dry grass blowing", "The cold dawn whispers")),
                climax = PlotStage("4. Twilight Transcendence", "Flight of the Egret", "Visual culmination of day giving way to the velvet gathering of night.", listOf("White bird ascends", "Crimson sky darkens")),
                resolution = PlotStage("5. Urban Epiphany", "The Metro Encounter", "Technological alienation redeemed by a moment of human warmth.", listOf("Metro door closes", "Shared smile remains"))
            ),
            characters = listOf(
                LiteratureCharacter(
                    name = "The Poetic Persona (Speaker)",
                    role = "The Contemplative Observer",
                    description = "An attentive, mindful witness who perceives deep philosophical meaning in small, everyday phenomena.",
                    keyActionsAndQuotes = listOf("Observes the ripple", "Records the farmer's toil", "Notices the stranger's smile"),
                    relationships = "Witness to both natural cycles and human struggles.",
                    examRelevance = "The voice is objective yet compassionate, practicing linguistic restraint."
                ),
                LiteratureCharacter(
                    name = "The Savanna Farmer",
                    role = "Embodiment of Human Resilience",
                    description = "A rural agrarian laborer striking hardened soil in anticipation of life-giving rain.",
                    keyActionsAndQuotes = listOf("Striking the iron earth with a hoe"),
                    relationships = "Tied intimately to the soil and weather.",
                    examRelevance = "Symbolizes unyielding patience and perseverance."
                )
            ),
            themes = listOf(
                LiteratureTheme(
                    title = "Man and Nature's Reciprocity",
                    explanation = "Human existence is fundamentally entwined with seasonal cycles, rain, dust, and dawn.",
                    appearanceInStory = "Every stanza anchors human emotion in physical environmental phenomena.",
                    examplesAndEvents = listOf("The farmer awaiting rain", "The dawn whispering to sleepers"),
                    examTakeaway = "Primary theme: Nature is not separate from human emotion."
                ),
                LiteratureTheme(
                    title = "Transience and the Ephemeral Moment (Satori)",
                    explanation = "Life consists of fleeting moments of intense clarity that vanish if not observed mindfully.",
                    appearanceInStory = "The quick flight of the egret and the dissolving reflection in the subway door.",
                    examplesAndEvents = listOf("The white egret against the sunset", "The stranger's warm smile"),
                    examTakeaway = "Haiku freezes a single second in eternity."
                ),
                LiteratureTheme(
                    title = "Economy of Language and Radical Brevity",
                    explanation = "True poetic power lies in withholding excess words and letting stark images evoke emotional resonance.",
                    appearanceInStory = "Strict 3-line format with dense compression.",
                    examplesAndEvents = listOf("17 syllables conveying universal human truth."),
                    examTakeaway = "Students must recognize how brevity amplifies meaning."
                )
            ),
            literaryDevices = listOf(
                LiteratureDevice(
                    deviceName = "Kigo (Season Word)",
                    definition = "A traditional poetic marker indicating the season or environmental climate.",
                    exactExcerpt = "'Dry savanna dust', 'Harmattan breeze', 'Raindrop'.",
                    contextAndAnalysis = "Anchors the poem in specific ecological time without need for lengthy exposition.",
                    examImportance = "Core definition tested in UTME poetry."
                ),
                LiteratureDevice(
                    deviceName = "Kireji (The Cutting Word / Caesura)",
                    definition = "A structural pause or punctuation break that juxtaposes two contrasting images.",
                    exactExcerpt = "'The hoe strikes the iron earth— / Waiting for the storm.'",
                    contextAndAnalysis = "The em-dash creates an abrupt pause, allowing the resonance of the first image to echo before the second image enters.",
                    examImportance = "Essential haiku structural device."
                ),
                LiteratureDevice(
                    deviceName = "Sensory Imagery",
                    definition = "Language that appeals directly to the physical senses: sight, sound, touch.",
                    exactExcerpt = "Visual: 'crimson sunset', 'white egret'; Auditory: 'silence finds its voice'; Tactile: 'iron earth', 'cold dawn'.",
                    contextAndAnalysis = "Evokes immediate visceral reality in the reader's imagination.",
                    examImportance = "High probability UTME question."
                ),
                LiteratureDevice(
                    deviceName = "Personification",
                    definition = "Attributing human actions or emotions to non-human elements.",
                    exactExcerpt = "'Silence finds its voice', 'The cold dawn whispers', 'Night gathers the sky'.",
                    contextAndAnalysis = "Endows nature with active, sentient presence.",
                    examImportance = "Frequently asked in figurative language questions."
                )
            ),
            setting = LiteratureSetting(
                whereLocations = listOf(
                    "The Rain Pond" to "A quiet body of water capturing ripples.",
                    "The Dry Savanna" to "Arid agricultural farmland awaiting rain.",
                    "The Village Rooftops" to "Habitations covered in Harmattan dust.",
                    "The City Metro" to "Modern electric subway car with glass reflections."
                ),
                whenTimePeriod = "Contemporary era, spanning dawn, midday heat, twilight, and evening.",
                socialEnvironmentalSetting = "Bridging traditional rural agricultural life and modern urban experience.",
                symbolicSignificance = "The setting moves from pure nature to industrialized human society, proving beauty exists in both."
            ),
            importantFacts = listOf(
                ImportantFactItem("Form", "Traditional haiku consists of 17 syllables in a 5-7-5 structure.", "Count syllables when asked about form."),
                ImportantFactItem("Origin", "Originated in Japan; modernized globally in English and African literature.", "Originated in Japanese poetry."),
                ImportantFactItem("Key Rule", "Haiku does not typically use end rhymes; it relies on rhythm and imagery.", "Haiku is unrhymed verse.")
            ),
            quickRevision = QuickRevisionSheet(
                oneSentenceSummary = "A collection of precise three-line poems capturing nature's fleeting moments, rural labor, seasonal transitions, and urban epiphanies through stark imagery.",
                coreSynopsis = "Modern Haiku utilizes the classical three-line structure (5-7-5 syllables) to crystallize brief moments of heightened perception. Exploring themes of nature, transience, resilience, and human warmth, each verse employs season markers (kigo), cutting breaks (kireji), and sensory imagery to evoke profound emotional truth from everyday events.",
                keyCharactersSummary = listOf(
                    "The Speaker" to "Quiet, mindful observer.",
                    "The Farmer" to "Symbol of patient agrarian resilience."
                ),
                topThemes = listOf(
                    "Man and Nature" to "Interconnectedness of humanity and ecology.",
                    "Transience" to "The beauty of the fleeting second."
                ),
                dominantDevices = listOf(
                    "Kigo (Season Word)" to "Markers like Harmattan and raindrop.",
                    "Juxtaposition" to "Placing two distinct images side by side."
                ),
                tenMustKnowExamFacts = listOf(
                    "1. Haiku is composed of three unrhymed lines.",
                    "2. The traditional syllable pattern is 5-7-5 (17 syllables total).",
                    "3. 'Kigo' refers to a word indicating the season.",
                    "4. 'Kireji' is a cutting word or pause separating two thoughts.",
                    "5. Modern Haiku avoids decorative flowery adjectives in favor of stark concrete nouns.",
                    "6. Sensory imagery (visual, auditory, tactile) dominates the form.",
                    "7. Satori represents an instant flash of philosophical awareness or enlightenment.",
                    "8. The form originated from Japanese renga in the 17th century.",
                    "9. Richard Wright helped pioneer modern English haiku in the 20th century.",
                    "10. Personification appears in lines like 'The cold dawn whispers'."
                )
            ),
            practiceQuestions = listOf(
                LiteratureQuizQuestion(
                    id = 801,
                    question = "What is the traditional syllable pattern of a classical haiku?",
                    options = listOf(
                        "A) 7-5-7 syllables",
                        "B) 5-7-5 syllables",
                        "C) 4-4-4 syllables",
                    ...
                    correctIndex = 1,
                    explanation = "Classical haiku is structured as a tercet of three lines containing 5, 7, and 5 syllables respectively (17 syllables total).",
                    questionType = "Past Question",
                    relatedChapter = "Poem 1"
                ),
                LiteratureQuizQuestion(
                    id = 802,
                    question = "In Japanese and modern haiku poetics, what does the term 'Kigo' signify?",
                    options = listOf(
                        "A) A rhyming couplet",
                        "B) A word indicating the season or climate",
                        "C) An insult between characters",
                        "D) A concluding stanza"
                    ),
                    correctIndex = 1,
                    explanation = "Kigo is a season word (such as 'raindrop', 'Harmattan dust', or 'cherry blossom') that sets the ecological time of the poem.",
                    questionType = "Concept Question",
                    relatedChapter = "Poem 2"
                ),
                LiteratureQuizQuestion(
                    id = 803,
                    question = "The line 'The cold dawn whispers' is an example of which literary device?",
                    options = listOf(
                        "A) Hyperbole",
                        "B) Oxymoron",
                        "C) Personification",
                    ...
                    correctIndex = 2,
                    explanation = "'Whispers' attributes human speech capability to the inanimate 'dawn', which is personification.",
                    questionType = "Literary Device",
                    relatedChapter = "Poem 3"
                ),
                LiteratureQuizQuestion(
                    id = 804,
                    question = "What is the primary function of the cutting break (kireji) in haiku?",
                    options = listOf(
                        "A) To make the poem rhyme",
                        "B) To create a pause and juxtapose two contrasting images",
                        "C) To indicate the title of the book",
                        "D) To count the number of characters"
                    ),
                    correctIndex = 1,
                    explanation = "The kireji acts as a conceptual break that juxtaposes two images, sparking a sudden flash of insight.",
                    questionType = "Structural Analysis",
                    relatedChapter = "Poem 4"
                ),
                LiteratureQuizQuestion(
                    id = 805,
                    question = "In 'Poem 2: Savanna Sun & Peasant Labor', what does the phrase 'iron earth' convey?",
                    options = listOf(
                        "A) A field made of metallic ores",
                        "B) Hardened, parched dry soil resisting the farmer's hoe",
                        "C) A modern tractor factory",
                        "D) A mining railway track"
                    ),
                    correctIndex = 1,
                    explanation = "'Iron earth' is a metaphor describing drought-hardened tropical savanna soil during the dry season.",
                    questionType = "Context Analysis",
                    relatedChapter = "Poem 2"
                )
            )
        )
    ...
    // -------------------------------------------------------------
    // DYNAMIC STUDY DATA GENERATOR (PART 1 & 17)
    // Converts ANY database entity into a full, 12-module study suite
    // -------------------------------------------------------------
    private fun generateStudyDataFromEntity(entity: LiteratureBookEntity): LiteratureBookStudyData {
        val parsedChapters = mutableListOf<LiteratureChapter>()

        if (!entity.chaptersJson.isNullOrBlank() && entity.chaptersJson.trim().startsWith("[")) {
            try {
                val jsonArr = JSONArray(entity.chaptersJson)
                for (i in 0 until jsonArr.length()) {
                    val obj = jsonArr.optJSONObject(i)
                    if (obj != null) {
                        val title = obj.optString("title", "Chapter ${i + 1}")
                        val content = obj.optString("content", "Study content for $title.")
                        val summary = obj.optString("summary", content.take(150) + "...")
                        parsedChapters.add(
                            LiteratureChapter(
                                chapterNumber = i + 1,
                                title = title,
                                summary = summary,
                                keyQuotes = listOf("Focus on $title"),
                                fullText = content
                            )
                        )
                    }
        ...
        if (parsedChapters.isEmpty()) {
            parsedChapters.add(
                LiteratureChapter(
                    chapterNumber = 1,
                    title = "Part 1: Overview & Foundation",
                    summary = entity.description.ifBlank { "Introductory study section for ${entity.title}." },
                    keyQuotes = listOf("Essential reading for JAMB Literature."),
                    fullText = """
                        ${entity.title} by ${entity.author}
                        Category: ${entity.category}

                        ${entity.description}

                        --- KEY STUDY NOTES ---
                        • Master the characters, their motivations, and their dilemmas.
                        • Pay attention to key turning points in the narrative arc.
                        • Review past UTME questions to identify recurring exam questions.
                    """.trimIndent()
                )
            )
        }

        val isPoem = entity.category.contains("Poem", ignoreCase = true) || entity.title.contains("Poem", ignoreCase = true)
        val isPlay = entity.category.contains("Drama", ignoreCase = true) || entity.category.contains("Play", ignoreCase = true)
        ...
        return LiteratureBookStudyData(
            ...
            authorInfo = AuthorInfo(
                name = entity.author,
                lifespan = "Notable Literary Figure",
                nationality = if (entity.category.contains("African", ignoreCase = true)) "African" else "Global",
                biography = "Renowned author of '${entity.title}', studied widely in secondary schools and the Joint Admissions and Matriculation Board (JAMB) syllabus.",
                notableWorks = listOf(entity.title),
                literaryMovementOrPeriod = if (isPoem) "Lyric Poetry" else if (isPlay) "Dramatic Realism" else "Narrative Prose",
                examSignificance = "Key prescribed text for candidates preparing for the Use of English and Literature-in-English examination."
            ),
            category = entity.category.ifBlank { "JAMB Literature Text" },
            publicationYear = "Prescribed UTME Edition",
            tagline = entity.description.take(80),
            coverAccentColor = BookCoverGreen,
            totalChaptersCount = parsedChapters.size,
            chapters = parsedChapters,
            background = LiteratureBackground(
                historicalContext = "Set within historical and cultural circumstances pertinent to the text's period.",
                socialContext = "Explores interpersonal relationships, social expectations, and cultural values.",
                circumstancesSurroundingWork = "Composed to examine critical dilemmas facing individuals in their society.",
                targetExamRelevance = "Important text for UTME questions on plot, characters, setting, and figures of speech."
            ),
            plot = LiteraturePlot(
                overview = "The narrative arc of '${entity.title}' structured across key dramatic phases.",
                beginning = PlotStage("1. Exposition", "Setting the Stage", "Introduction of key characters and primary situation.", listOf("Opening events establish the core conflict.")),
                majorEvents = PlotStage("2. Rising Action", "Developing Conflict", "Tensions escalate as characters face dilemmas.", listOf("Key turning events unfold.")),
                turningPoints = PlotStage("3. Turning Point", "The Decisive Shift", "A critical moment that alters character trajectories.", listOf("Crucial revelation takes place.")),
                climax = PlotStage("4. Climax", "Peak Confrontation", "The emotional and dramatic peak of the work.", listOf("Major confrontation occurs.")),
                resolution = PlotStage("5. Resolution", "Outcome & Meaning", "Final outcome and moral/thematic closure.", listOf("The narrative concludes with lessons for readers."))
            ),
            characters = listOf(
                LiteratureCharacter(
                    name = "Central Protagonist",
                    role = "Main Subject",
                    description = "The principal character whose journey forms the backbone of ${entity.title}.",
                    keyActionsAndQuotes = listOf("Drives the narrative momentum forward."),
                    relationships = "Interacts with major supporting cast.",
                    examRelevance = "Frequently tested in identification and character trait questions."
                )
            ),
            themes = listOf(
                LiteratureTheme(
                    title = "Primary Theme of ${entity.title}",
                    explanation = "Central moral and philosophical truth communicated by the work.",
                    appearanceInStory = "Woven throughout chapters and character interactions.",
                    examplesAndEvents = listOf("Demonstrated in pivotal scenes."),
                    examTakeaway = "Essential concept tested in UTME essay and objective questions."
                ),
                LiteratureTheme(
                    title = "Conflict and Resolution",
                    explanation = "The struggle between opposing forces that drives the plot.",
                    appearanceInStory = "Visible in confrontations and dialogue.",
                    examplesAndEvents = listOf("Tension between traditional and modern viewpoints."),
                    examTakeaway = "Understand how the central conflict is resolved."
                )
            ),
            literaryDevices = listOf(
                LiteratureDevice(
                    deviceName = if (isPoem) "Imagery & Symbolism" else if (isPlay) "Dramatic Irony" else "Narrative Foreshadowing",
                    definition = "Literary technique utilized by the author to deepen meaning and engage the audience.",
                    exactExcerpt = "Pivotal lines throughout ${entity.title}.",
                    contextAndAnalysis = "Enriches the thematic resonance and character psychology.",
                    examImportance = "Key exam question area."
                )
            ),
            setting = LiteratureSetting(
                whereLocations = listOf("Primary Setting" to "Key locations where major events occur."),
                whenTimePeriod = "The period depicted in the text.",
                socialEnvironmentalSetting = "The prevailing social and cultural atmosphere.",
                symbolicSignificance = "The setting mirrors internal character development and thematic conflict."
            ),
            importantFacts = listOf(
                ImportantFactItem("Title", entity.title, "Author: ${entity.author}"),
                ImportantFactItem("Genre", entity.category, "Ensure you identify genre correctly.")
            ),
            quickRevision = QuickRevisionSheet(
                oneSentenceSummary = entity.description.ifBlank { "Study guide for ${entity.title} by ${entity.author}." },
                coreSynopsis = entity.description.ifBlank { "Complete analysis covering plot, themes, characters, and exam questions." },
                keyCharactersSummary = listOf("Protagonist" to "Central figure."),
                topThemes = listOf("Main Theme" to "Core lesson of the work."),
                dominantDevices = listOf("Dominant Device" to "Key literary technique."),
                tenMustKnowExamFacts = listOf(
                    "1. Title: ${entity.title}",
                    "2. Author: ${entity.author}",
                    "3. Category: ${entity.category}",
                    "4. Pay close attention to chapter/scene summaries.",
                    "5. Character motives are tested regularly.",
                    "6. Identify literary devices in quoted excerpts.",
                    "7. Setting influences character choices.",
                    "8. Notice how the central conflict develops.",
                    "9. Review key quotes in the reader section.",
                    "10. Practice the attached mock questions."
                )
            ),
            practiceQuestions = listOf(
                LiteratureQuizQuestion(
                    id = 901,
                    question = "Who is the author of '${entity.title}'?",
                    options = listOf(
                        "A) ${entity.author}",
                        "B) Chinua Achebe",
                        "C) Wole Soyinka",
                    ...
                    correctIndex = 0,
                    explanation = "'${entity.title}' is written by ${entity.author}.",
                    questionType = "Author Identification",
                    relatedChapter = "Chapter 1"
                )
            )
        )
